...
// Re-export as Talk for backward compatibility
export type Talk = SpeakingTalk;
...
export function getFeaturedTalk(): SpeakingTalk | null {
  const talk = speakingTalks.find(talk => talk.featured);
  return talk ? enrichTalkWithAvailability(talk) : null;
}
